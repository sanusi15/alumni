        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?= base_url('mahasiswa'); ?>" class="nav-link">Dashboard</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <?php if ($mhs['foto'] != '') : ?>
                            <img style="width:50px; height:50px;" src="assets/img/<?= $mhs['foto']; ?>" class="img-circle elevation-2" alt="User Image">
                        <?php else : ?>
                            <img src="assets/admin/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
                        <?php endif; ?>
                    </div>
                    <div class="info">
                        <a href="#" class="d-block"><?= $mhs['nama']; ?></a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <a href="<?= base_url('mahasiswa/signOut'); ?>" class="nav-link <?= ($this->uri->segment(1) === '' ? 'active' : '')  ?>">
